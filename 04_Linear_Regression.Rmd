...
```{r}
# plot response against individual predictors
...
```{r}
# add interaction terms. Not successful
...
```{r}
# final model called "final_model" with the form log(selling_price_dollars)~ .-Make-engine + I(age^2)
final_logY_agepoly <- lm(log(selling_price_dollars)~ .-Make-engine + I(age^2),
             data = vehicles_lr)
